			...
			public void handle(KeyEvent event) {
				...
				if (enteredvehicle == null) {
					...
					case LEFT, A:
						...
						break;
					case E:
						player.setEnteredVehicle(
								(Vehicle) aonb.search(player.getX(), player.getY(), "machinery.Vehicle"));
					...
					case E:
						...
						break;
					case X:
						tractor.equip((Equipment) aonb.search(tractor.getX(), tractor.getY(), "machinery.Equipment"));
						break;
					case F:
