...
public class WheatfieldActions {
	...
	/**
	 * A function that returns all wheatfieldTrackers into a unified hashmap of type
	 * <String, ArableField>
	 * 
	 * @return HashMap<String, ArableField> containing all fields with their String
	 *         position-ID as the key.
	 */
